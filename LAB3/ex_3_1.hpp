...
glm::mat4 createCameraMatrix(){
	...
	glm::vec3 wektor = glm::vec3(0.f, 1.f, 0.f);
	glm::vec3 cameraSide = glm::normalize(glm::cross(cameraDir, wektor));
...
glm::mat4 createPerspectiveMatrix(){
	...
	glm::mat4 perspectiveMatrix = glm::mat4({
		aspectRatio2*s,0.,0.,0.,  // zmniejszenie wartości w m11 i m22 większy kąt widzenia danej osi.-> to te parametry odpowiadają za ściskanie i rozszerzanie przestrzeni w tych osiach.
		0.,aspectRatio*s,0.,0.,
...
void framebuffer_size_callback(GLFWwindow* window, int width, int height)
{
	...
	//aspectRatio2 = (height / float(width))*2;
